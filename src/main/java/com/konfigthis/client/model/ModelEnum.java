...
public class ModelEnum {
  ...
  public ModelEnum id(Integer id) {
  ...
  **/
  ...
  public ModelEnum code(String code) {
  ...
  **/
   ...
   * @return the ModelEnum instance itself
   */
  public ModelEnum putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, _enum.id) &&
        Objects.equals(this.name, _enum.name) &&
        Objects.equals(this.code, _enum.code)&&
        Objects.equals(this.additionalProperties, _enum.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ModelEnum
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ModelEnum.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ModelEnum>() {
           ...
           public ModelEnum read(JsonReader in) throws IOException {
             ...
             ModelEnum instance = thisAdapter.fromJsonTree(jsonObj);
